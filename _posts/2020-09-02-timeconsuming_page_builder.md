---
title: 'Timeconsuming_page_builder'
category: 'Flutter'
layout: post
...
这是一个`Flutter Package`，支持`Flutter(ANDROID/IOS/WEB)`，极大的降低了耗时页面中代码逻辑的复杂度，提高代码的可读性。为了方便使用者测试（当然，如果不介意，也可以用于生产环境中），该库也提供了额外三个`Widget`：
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcwMTEwNzcxNSwtNTM2NjI3MzIxLC0zOT
EzMjc0MjYsMjEyMTM2MjA4OCwtOTkyOTg4NDI4LC05OTI5ODg0
MjhdfQ==
-->