...
我们可以对`Producer`的类型参数（type parameter）T进行注释，以确保仅从`Producer<T>`的produce方法返回（产生）该参数，并且永不使用它。为此我们提供`out`修饰符（**variance annotation**）：
```kotlin
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODgyNzQ4NDIzLC0xNzMzMjE3Mjk4LDE2Mz
c4NDQ3MjMsMjUxODM2MzE4LC0xNTUwNDQ2MTMxLC04MzA2MDcy
OTIsMTg4OTgxNDYyOCw3MzA5OTgxMTZdfQ==
-->